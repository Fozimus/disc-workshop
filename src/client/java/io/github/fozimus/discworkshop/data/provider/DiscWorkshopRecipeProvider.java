...
public class DiscWorkshopRecipeProvider extends FabricRecipeProvider{
	...
	public String getName() {
        return "DiscWorkshopRecipeProvied";
	}
	...
	protected RecipeGenerator getRecipeGenerator(WrapperLookup registryLookup, RecipeExporter exporter) {
        return new RecipeGenerator(registryLookup, exporter) {
            ...
            public void generate() {
                ...
                ShapedRecipeJsonBuilder.create(itemLookup, RecipeCategory.MISC, ItemInit.BLANK_DISC)
                    .input('S', Items.STONE)
                ...
                ShapedRecipeJsonBuilder.create(itemLookup, RecipeCategory.MISC, BlockInit.DISC_WORKSHOP_BE_BLOCK)
